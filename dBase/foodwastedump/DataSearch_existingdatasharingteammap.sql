...
--
-- Name: DataSearch_existingdatasharingteammap DataSearch_existingda_team_id_1c14a1f5_fk_teams_tea; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_existingdatasharingteammap"
    ADD CONSTRAINT "DataSearch_existingda_team_id_1c14a1f5_fk_teams_tea" FOREIGN KEY (team_id) REFERENCES public.teams_team(id) DEFERRABLE INITIALLY DEFERRED;
