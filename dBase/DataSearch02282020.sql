...
COPY public."DataSearch_existingdata" (id, work, email, phone, search, source_title, keywords, url, disclaimer_req, citation, date_accessed, comments, created_by_id, source_id) FROM stdin;
\.
...
1	pbkdf2_sha256$180000$Vmo6Q2n9nlia$APlqU+/qSDSX6hkXG2HD4mURvwLtQwx47iBl/NMWyy0=	2020-02-28 07:50:25.199646-05	t	dyoung11	Daniel	Young	Young.Daniel@epa.gov	t	t	2019-07-16 08:00:00-04
\.
...
SELECT pg_catalog.setval('public."DataSearch_attachment_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."DataSearch_dataattachmentmap_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."DataSearch_existingdata_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."DataSearch_existingdatasharingteammap_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."DataSearch_existingdatasource_id_seq"', 1, false);
...
--
-- Name: DataSearch_attachment_uploaded_by_id_3226bc7a; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_attachment_uploaded_by_id_3226bc7a" ON public."DataSearch_attachment" USING btree (uploaded_by_id);


--
-- Name: DataSearch_dataattachmentmap_attachment_id_b9167be2; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_dataattachmentmap_attachment_id_b9167be2" ON public."DataSearch_dataattachmentmap" USING btree (attachment_id);


--
-- Name: DataSearch_dataattachmentmap_data_id_3e96903a; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_dataattachmentmap_data_id_3e96903a" ON public."DataSearch_dataattachmentmap" USING btree (data_id);


--
-- Name: DataSearch_existingdata_created_by_id_c4d9050c; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_existingdata_created_by_id_c4d9050c" ON public."DataSearch_existingdata" USING btree (created_by_id);


--
-- Name: DataSearch_existingdata_source_id_f1e41485; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_existingdata_source_id_f1e41485" ON public."DataSearch_existingdata" USING btree (source_id);


--
-- Name: DataSearch_existingdatasharingteammap_data_id_213b61ee; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_existingdatasharingteammap_data_id_213b61ee" ON public."DataSearch_existingdatasharingteammap" USING btree (data_id);


--
-- Name: DataSearch_existingdatasharingteammap_team_id_6f7e8356; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "DataSearch_existingdatasharingteammap_team_id_6f7e8356" ON public."DataSearch_existingdatasharingteammap" USING btree (team_id);
...
--
-- Name: DataSearch_attachment DataSearch_attachment_uploaded_by_id_3226bc7a_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_attachment"
    ADD CONSTRAINT "DataSearch_attachment_uploaded_by_id_3226bc7a_fk_auth_user_id" FOREIGN KEY (uploaded_by_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: DataSearch_dataattachmentmap DataSearch_dataattac_attachment_id_b9167be2_fk_DataSearc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_dataattachmentmap"
    ADD CONSTRAINT "DataSearch_dataattac_attachment_id_b9167be2_fk_DataSearc" FOREIGN KEY (attachment_id) REFERENCES public."DataSearch_attachment"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: DataSearch_dataattachmentmap DataSearch_dataattac_data_id_3e96903a_fk_DataSearc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_dataattachmentmap"
    ADD CONSTRAINT "DataSearch_dataattac_data_id_3e96903a_fk_DataSearc" FOREIGN KEY (data_id) REFERENCES public."DataSearch_existingdata"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: DataSearch_existingdatasharingteammap DataSearch_existingd_data_id_213b61ee_fk_DataSearc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_existingdatasharingteammap"
    ADD CONSTRAINT "DataSearch_existingd_data_id_213b61ee_fk_DataSearc" FOREIGN KEY (data_id) REFERENCES public."DataSearch_existingdata"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: DataSearch_existingdata DataSearch_existingd_source_id_f1e41485_fk_DataSearc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_existingdata"
    ADD CONSTRAINT "DataSearch_existingd_source_id_f1e41485_fk_DataSearc" FOREIGN KEY (source_id) REFERENCES public."DataSearch_existingdatasource"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: DataSearch_existingdatasharingteammap DataSearch_existingd_team_id_6f7e8356_fk_teams_tea; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_existingdatasharingteammap"
    ADD CONSTRAINT "DataSearch_existingd_team_id_6f7e8356_fk_teams_tea" FOREIGN KEY (team_id) REFERENCES public.teams_team(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: DataSearch_existingdata DataSearch_existingdata_created_by_id_c4d9050c_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DataSearch_existingdata"
    ADD CONSTRAINT "DataSearch_existingdata_created_by_id_c4d9050c_fk_auth_user_id" FOREIGN KEY (created_by_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
