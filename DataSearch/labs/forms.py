...
class LabForm(forms.ModelForm):
	"""
	A Form For Creating a Lab Tied To
	"""

	def __init__(self, *args, **kwargs):
		super(LabForm, self).__init__(*args, **kwargs)
	
	the_name = forms.CharField(label=_("Lab Name"), widget=forms.TextInput(attrs={'class':'form-control'}), required=True)	
	...
	the_description = forms.CharField(label=_("Description of Lab"), widget=forms.Textarea(attrs={'class':'form-control'}), required=False)
