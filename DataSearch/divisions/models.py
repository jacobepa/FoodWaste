...
def get_division_path(instance, filename):
	return '%s/divisions/%s' %(instance.user.username, filename)
...
class Division(models.Model):
	...
	attachment = models.FileField(null=True, blank=True, upload_to=get_division_path)
